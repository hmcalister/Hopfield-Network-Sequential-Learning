...
class BipolarOrthogonalGenerator():

    def __init__(self, N:int, activeUnits:int):
        """
        Return a new instance of a BipolarOrthogonalGenerator mapping function
        Takes a size of vector to return (N), and a ratio to set to ones (activeUnits)
        e.g. if N=10 and activeUnits=2, we will produce patterns like (1,1,-1,-1...), (-1,-1,1,1,....) etc
    ...
    def __str__(self):
        return "BipolarOrthogonalGenerator"